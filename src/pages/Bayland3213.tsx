...
import subpageHero from "@/assets/bayland-3213-ext-01.jpg";
import ext01 from "@/assets/bayland-3213-ext-01.jpg";
import ext02 from "@/assets/bayland-3213-ext-02.jpg";
import ext03 from "@/assets/bayland-3213-ext-03.jpg";
import ext04 from "@/assets/bayland-3213-ext-04.jpg";
import ext05 from "@/assets/bayland-3213-ext-05.jpg";
import ext06 from "@/assets/bayland-3213-ext-06.jpg";
import floorGround from "@/assets/bayland-3213-floor-ground-3d.jpg";
import floorFirst from "@/assets/bayland-3213-floor-first-3d.jpg";
import floorSecond from "@/assets/bayland-3213-floor-second-3d.jpg";
import intLiving from "@/assets/bayland-3213-int-living.jpg";
import intKitchen from "@/assets/bayland-3213-int-kitchen.jpg";
import intDining from "@/assets/bayland-3213-int-dining.jpg";
import intMaster from "@/assets/bayland-3213-int-master.jpg";
import intBedroom from "@/assets/bayland-3213-int-bedroom.jpg";
import intBath from "@/assets/bayland-3213-int-bath.jpg";

const propertyData = {
  name: "3213 Bayland Drive",
  unit: "Baylandings Single-Family Residence",
  headline: "Bayside Oasis · Custom New Construction",
  tagline: "A custom new-construction masterpiece in Ocean City's exclusive Baylandings neighborhood — five bedrooms, five-and-a-half baths, private elevator, gas log fireplace, in-ground pool, and breathtaking bay and sunset views.",
  description: "Offered by Ocean City Development Group and designed by Halliday Architects, 3213 Bayland Drive is a two-story new-construction residence on a 50 × 100 lot in the coveted Baylandings community. Wide-plank hardwood floors run throughout, the gourmet kitchen is appointed with GE Monogram appliances, custom-tiled bathrooms anchor each level, and a private in-ground pool completes the bayside lifestyle.",
  status: "Active Listing",
  price: "$2,995,000",
  location: { city: "Ocean City", state: "NJ" },
  details: { bedrooms: 5, fullBaths: 5, halfBaths: 1, totalRooms: 14 },
  contact: {
  ...
  specs: [
    { icon: "fireplace", title: "Built-In Gas Log Fireplace", description: "A built-in gas log fireplace anchors the living room — the warm centerpiece of relaxed bayside evenings." },
    { icon: "hardwood", title: "Wide-Plank Hardwood Floors", description: "Wide-plank hardwood flooring runs throughout, paired with cathedral ceilings and a refined trim package." },
    { icon: "hvac", title: "Natural-Gas Heat & Multi-Zone AC", description: "Multi-zoned forced-air natural-gas heating, gas water heater, and central air conditioning deliver year-round comfort." },
    { icon: "rooftop", title: "GE Monogram Gourmet Kitchen", description: "A chef-grade kitchen with center island, walk-in pantry, and full GE Monogram appliance package designed for entertaining." },
  ],
  luxuryFeatures: [
    "OCDG custom new construction · 2027",
    "Halliday Architects design",
    "2-story home · 50 × 100 bayside lot · Baylandings",
    "Private elevator serving all levels",
    "Cathedral ceilings · open layout",
    "Built-in gas log fireplace · living room",
    "Gourmet kitchen · GE Monogram appliances · center island",
    ...
    "Gas water heater",
    "Finished basement with 6-ft head room",
    "Attached two-car garage · concrete driveway",
    "Private in-ground pool · deck · sprinkler system",
  ],
  locationFeatures: [
    "Baylandings · Ocean City's exclusive bayside enclave",
    "Breathtaking water and sunset views",
    "Quick access via Bay Avenue and Waterway Road",
    "Lot 7 · Block 3207 · 50 × 100",
  ],
  highlights: [
    { value: "5", label: "Bedrooms" },
    { value: "5.5", label: "Bathrooms" },
    { value: "14", label: "Total Rooms" },
  ...
  floorPlans: [
    {
      ...
      name: "Ground Floor",
      image: floorGround,
      description: "The ground level — entry foyer, attached two-car garage with auto door opener, finished basement with 6-ft head room, and direct backyard access to the in-ground pool and deck.",
      highlights: [
        "Entry Foyer",
    ...
    },
    {
      ...
      name: "First Floor",
      image: floorFirst,
      description: "The social heart of the home — open living room with built-in gas log fireplace, gourmet GE Monogram kitchen with center island, walk-in pantry, eat-in dining, and a powder room. Cathedral ceilings, wide-plank hardwood floors, and water views throughout.",
      highlights: [
        "Open Living Room · Gas Fireplace",
        "GE Monogram Gourmet Kitchen",
        "Center Island · Walk-In Pantry",
        "Eat-In Dining Room",
        "Water Views",
        "Hardwood Floors",
      ],
    },
    {
      ...
      name: "Second Floor",
      image: floorSecond,
      description: "The bedroom level — a generous primary suite with walk-in closet and spa-style custom tile bath, four additional bedrooms with full bath access, and a dedicated laundry/utility room.",
      highlights: [
...
const exteriorImages = [
  { src: ext01, alt: "3213 Bayland Drive — Front Exterior" },
  { src: ext02, alt: "3213 Bayland Drive — Street Perspective" },
  { src: ext03, alt: "3213 Bayland Drive — Side Elevation" },
  { src: ext04, alt: "3213 Bayland Drive — Bayside Perspective" },
  { src: ext05, alt: "3213 Bayland Drive — Rear Elevation" },
  { src: ext06, alt: "3213 Bayland Drive — Detail View" },
];

const interiorImages: { src: string; alt: string }[] = [
  { src: intLiving, alt: "3213 Bayland Drive — Open Living Room with Gas Fireplace" },
  { src: intKitchen, alt: "3213 Bayland Drive — GE Monogram Gourmet Kitchen" },
  { src: intDining, alt: "3213 Bayland Drive — Eat-In Dining" },
  { src: intMaster, alt: "3213 Bayland Drive — Primary Bedroom Suite" },
  { src: intBedroom, alt: "3213 Bayland Drive — Guest Bedroom" },
  { src: intBath, alt: "3213 Bayland Drive — Custom-Tiled Bath" },
];
...
const Bayland3213 = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Thank you. Our team will be in touch regarding 3213 Bayland Drive shortly.");
    ...
    <main className="min-h-screen">
        ...
        <div ref={visionRef} className="container mx-auto px-6 lg:px-12">
          <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center transition-all duration-1000 ${visionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="order-2 lg:order-1">
              ...
              <h2 className="heading-section text-charcoal mb-6">A Bayside Coastal Residence</h2>
              ...
              <div className="space-y-6">
                <p className="text-body">
                  <strong className="text-charcoal">Ground Floor:</strong> Entry foyer, attached two-car garage, finished basement with 6-ft head room, and direct access to the backyard with private in-ground pool.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">First Floor:</strong> An open living room with built-in gas log fireplace flows into the GE Monogram gourmet kitchen with center island, walk-in pantry, eat-in dining, and a powder room — anchored by cathedral ceilings, wide-plank hardwood, and water views.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">Second Floor:</strong> A primary suite with walk-in closet and spa-style tile bath, four additional bedrooms with custom-tiled bathrooms, and a dedicated laundry/utility room.
                </p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <div className="relative">
                <img
                  src={ext03}
                  alt="3213 Bayland Drive — Coastal Architecture"
                ...
                <div className="absolute -bottom-6 -left-6 w-40 h-24 border border-border bg-white flex items-center justify-center p-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm font-serif text-charcoal">Bayside Residence</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="specs" className="section-padding section-sand">
        <div ref={specsRef} className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl">
          ...
          <div className="text-center mt-12">
            <a
              href="https://sjsr.paragonrels.com/paragonls/publink/view.mvc/?GUID=71493d88-5740-44f1-8b40-7992bd7f713f&Report=Yes"
              target="_blank"
        ...
        <div ref={locationRef} className="container mx-auto px-6 lg:px-12 max-w-7xl">
          <div className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ${locationVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="relative h-[400px] lg:h-[500px] bg-muted">
              <iframe
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=3213+Bayland+Dr,+Ocean+City,+NJ"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
      ...
      <nav className="border-t border-border py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl flex items-center justify-between">
          <Link to="/developments/current-projects/3112-bay-ave" className="text-xs tracking-[0.15em] uppercase text-muted-slate hover:text-charcoal transition-colors">
            ← 3112 Bay Ave
          </Link>
