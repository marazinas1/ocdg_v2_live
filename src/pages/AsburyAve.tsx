...
import morningsideHero from "@/assets/exterior-front.jpg";
import { toast } from "sonner";
import { useScrollReveal } from "@/hooks/useScrollReveal";

import subpageHero from "@/assets/asbury-ext-01.jpg";
import ext01 from "@/assets/asbury-ext-01.jpg";
import ext02 from "@/assets/asbury-ext-02.jpg";
import ext03 from "@/assets/asbury-ext-03.jpg";
import ext04 from "@/assets/asbury-ext-04.jpg";
import ext05 from "@/assets/asbury-ext-05.jpg";
import ext06 from "@/assets/asbury-ext-06.jpg";
import floor1st from "@/assets/asbury-floor-1st.jpg";
import floor2nd from "@/assets/asbury-floor-2nd.jpg";
import floorAttic from "@/assets/asbury-floor-attic.jpg";
import intLiving from "@/assets/asbury-int-living.jpg";
import intKitchen from "@/assets/asbury-int-kitchen.jpg";
import intMasterbed from "@/assets/asbury-int-masterbed.jpg";
import intBathroom from "@/assets/asbury-int-bathroom.jpg";
import intDining from "@/assets/asbury-int-dining.jpg";
import intJrMaster from "@/assets/asbury-int-jrmaster.jpg";

const propertyData = {
  name: "2029 Asbury Ave",
  headline: "Gold Coast Living",
  tagline: "A 2.5-story new construction residence in Ocean City's coveted Gold Coast — five bedrooms, an elevator, and five expansive decks, positioned on the ocean side of Asbury Ave between 20th and 21st Streets.",
  description: "This ground-up single-family home delivers the full OCDG Standard: a 4-stop residential elevator, gas log fireplace in the living room, multi-zoned HVAC, hardwood flooring throughout, and an enclosed outdoor shower. Three front decks and two rear decks maximize ocean breezes and outdoor living at every level.",
  ...
  specs: [
    { icon: "elevator", title: "4-Stop Elevator", description: "Accredited residential elevator serving all levels, from ground-floor entry to the top-floor master suites." },
    { icon: "fireplace", title: "Gas Log Fireplace", description: "Built-in gas log fireplace in the living room — a warm centerpiece for year-round coastal living." },
    { icon: "hvac", title: "Multi-Zoned HVAC", description: "Independently controlled climate zones for maximum comfort across all three stories and 13 rooms." },
    { icon: "hardwood", title: "Hardwood Flooring", description: "Premium hardwood flooring throughout all living spaces, paired with custom tile work in every bathroom." },
  ],
  luxuryFeatures: [
    "4-stop residential elevator",
    "Gas log fireplace · built-in, living room",
    "Multi-zoned HVAC throughout",
    "Hardwood flooring in all living spaces",
    "5 decks — 3 front & 2 rear",
    "Enclosed outdoor shower",
    "Kitchen center island with quartz countertops",
    "Sprinkler system & attached garage",
  ],
  locationFeatures: [
    "Gold Coast area — Ocean City's premier corridor",
    "Ocean side of Asbury Ave, between 20th & 21st Streets",
  ...
  floorPlans: [
    {
      ...
      name: "Ground Level",
      image: floor1st,
      description: "Two bedrooms, one hall bath, laundry/utility room, and elevator access. A functional ground level designed for effortless daily living.",
      highlights: [
        "2 Bedrooms with Hall Bath",
        "Laundry & Utility Room",
        "4-Stop Elevator Access",
    ...
    },
    {
      ...
      name: "Second Floor",
      image: floor2nd,
      description: "The heart of the home — an expansive kitchen with center island, large living room with gas fireplace, dining area, half bath, and a bedroom with en-suite bath.",
      highlights: [
    ...
    },
    {
      ...
      name: "Top Floor",
      image: floorAttic,
      description: "Two spacious bedrooms, each with a private bathroom — your personal retreat above it all with ocean breezes and expansive deck access.",
      highlights: [
        "2 Bedrooms with Private Baths",
        "Expansive Deck Access",
        "Ocean Breezes",
...
const exteriorImages = [
  { src: ext01, alt: "2029 Asbury Ave — Front Exterior View" },
  { src: ext02, alt: "2029 Asbury Ave — Rear Exterior with Garage" },
  { src: ext03, alt: "2029 Asbury Ave — Aerial Perspective" },
  { src: ext04, alt: "2029 Asbury Ave — Porch & Landscaping Detail" },
  { src: ext05, alt: "2029 Asbury Ave — Evening Exterior View" },
  { src: ext06, alt: "2029 Asbury Ave — Driveway & Entry" },
];

const interiorImages = [
  { src: intLiving, alt: "2029 Asbury Ave — Living Room & Great Room" },
  { src: intKitchen, alt: "2029 Asbury Ave — Chef's Kitchen" },
  { src: intMasterbed, alt: "2029 Asbury Ave — Master Suite" },
  { src: intBathroom, alt: "2029 Asbury Ave — Bathroom & Tile Detail" },
  { src: intDining, alt: "2029 Asbury Ave — Dining & Entertainment" },
  { src: intJrMaster, alt: "2029 Asbury Ave — Junior Master Bedroom" },
];
...
const AsburyAve = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Thank you. Our team will be in touch regarding 2029 Asbury Ave shortly.");
          ...
          <div className="max-w-3xl animate-fade-in-up">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-6 text-white/80">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs md:text-sm">Gold Coast · Ocean City</span>
              </div>
            </div>
        ...
        <div ref={visionRef} className="container mx-auto px-6 lg:px-12">
          <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center transition-all duration-1000 ${visionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="order-2 lg:order-1">
              ...
              <h2 className="heading-section text-charcoal mb-6">Gold Coast Living</h2>
              ...
              <div className="space-y-6">
                <p className="text-body">
                  <strong className="text-charcoal">Ground Level:</strong> Two bedrooms with a shared hall bath, laundry/utility room, and 4-stop elevator access. An attached garage provides ample storage and two-car exterior parking.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">Second Floor:</strong> The heart of the home — an expansive kitchen with center island, a large living room anchored by a gas log fireplace, dining area, half bath, and a bedroom with en-suite bath.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">Top Floor:</strong> Two spacious bedrooms, each with a private bathroom — your personal retreat above it all with ocean breezes and deck access.
                </p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <div className="relative">
                <img
                  src={ext03}
                  alt="2029 Asbury Ave — Aerial View"
                ...
                <div className="absolute -bottom-6 -left-6 w-40 h-24 border border-border bg-white flex items-center justify-center p-4">
                  <div className="text-center">
                    <p className="text-xs uppercase tracking-wider text-muted-slate mb-1">Gold Coast</p>
                    <p className="text-sm font-serif text-charcoal">Ocean Side of Asbury</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div ref={locationRef} className="container mx-auto px-6 lg:px-12 max-w-7xl">
          <div className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ${locationVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="relative h-[400px] lg:h-[500px] bg-muted">
              <iframe
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=2029+Asbury+Ave,+Ocean+City,+NJ"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
