...
import { Bed, Bath, MapPin, Phone, Mail, X, ChevronLeft, ChevronRight, ArrowUpFromLine, Flame, Thermometer, TreePine, Download } from "lucide-react";
import { toast } from "sonner";
import { useScrollReveal } from "@/hooks/useScrollReveal";

import subpageHero from "@/assets/simpson-ext-01.jpg";
import ext01 from "@/assets/simpson-ext-01.jpg";
import ext02 from "@/assets/simpson-ext-02.jpg";
import ext03 from "@/assets/simpson-ext-03.jpg";
import ext04 from "@/assets/simpson-ext-04.jpg";
import ext05 from "@/assets/simpson-ext-05.jpg";
import ext06 from "@/assets/simpson-ext-06.jpg";
import floor1st from "@/assets/simpson-floor-1st.jpg";
import floor2nd from "@/assets/simpson-floor-2nd.jpg";
import floorAttic from "@/assets/simpson-floor-attic.jpg";
import intLiving from "@/assets/simpson-int-living.jpg";
import intKitchen from "@/assets/simpson-int-kitchen.jpg";
import intMasterbed from "@/assets/simpson-int-masterbed.jpg";
import intBathroom from "@/assets/simpson-int-bathroom.jpg";
import intDining from "@/assets/simpson-int-dining.jpg";
import intJrMaster from "@/assets/simpson-int-jrmaster.jpg";

const propertyData = {
  name: "1113 Simpson Ave",
  headline: "Custom Coastal Living",
  tagline: "A custom-built, upside-down style new construction residence on an oversized 40' × 115' lot in the center of the island — five bedrooms, an elevator, and a built-in gas fireplace at the heart of effortless coastal living.",
  description: "This high-end single family home sits in the heart of Ocean City, just minutes from the beach, boardwalk, and downtown. Upside-down living lifts the main great room to the second floor for natural light and ocean breezes, while the ground level houses bedrooms, garage, and elevator access. Gourmet kitchen with custom cabinetry and upgraded stainless-steel appliances, tile bathrooms, multi-zoned heat & AC, and a covered front porch with hardwood floors complete the package.",
  status: "New Construction · 2026",
  price: "$1,995,000",
  location: { city: "Ocean City", state: "NJ" },
  details: { bedrooms: 5, fullBaths: 3, halfBaths: 1, totalRooms: 9 },
  contact: {
  ...
  specs: [
    { icon: "elevator", title: "Residential Elevator", description: "Accredited residential elevator serving every level — from the ground-floor entry to the upside-down great room above." },
    { icon: "fireplace", title: "Built-In Gas Fireplace", description: "A built-in gas fireplace anchors the family room / bonus den — the warm centerpiece of the upside-down great room." },
    { icon: "hvac", title: "Multi-Zoned HVAC", description: "Independent climate zones with forced-air natural gas heat and central air conditioning across all 9 rooms." },
    { icon: "hardwood", title: "Hardwood & Custom Tile", description: "Premium hardwood flooring throughout living spaces, custom tile bathrooms, and a covered 2nd-floor porch with hardwood." },
  ],
  luxuryFeatures: [
    "Custom-built upside-down style new construction",
    "Oversized 40' × 115' lot · center of the island",
    "Residential elevator serving every level",
    "Built-in gas fireplace · family room / bonus den",
    "Gourmet kitchen · custom cabinetry · upgraded stainless steel",
    "Multi-zoned heat & AC · forced air natural gas",
    "Huge 1st-level front porch & 2nd-floor covered porch",
    "Enclosed outdoor shower · 2-car garage · plenty of off-street parking",
  ],
  locationFeatures: [
    "Center of the island — equally close to bay and ocean",
    "Walk to the beach, boardwalk, and downtown dining",
    "Block 1107 · Lot 12 · Ocean City Central",
    "Beautifully landscaped 40' × 115' parcel",
  ],
  highlights: [
    { value: "5", label: "Bedrooms" },
    { value: "3.5", label: "Bathrooms" },
    { value: "Elevator", label: "All Levels" },
    { value: "9", label: "Rooms" },
  ...
  floorPlans: [
    {
      ...
      name: "Ground Level",
      image: floor1st,
      description: "The private retreat level — bedrooms, full bath, elevator landing, and direct access to the 2-car garage with abundant off-street parking. Designed for effortless beach-day living and seamless entry from the driveway.",
      highlights: [
        "Private Bedrooms with Hall Bath",
        "2-Car Garage & Concrete Driveway",
        "Elevator Landing · All Levels",
    ...
    },
    {
      ...
      image: floor2nd,
      description: "The upside-down great room — gourmet kitchen with center island and custom cabinetry, large open living area, dining, half bath, and the bonus den anchored by a built-in gas fireplace. Opens to a 2nd-floor covered porch with hardwood floors.",
      highlights: [
        "Open-Concept Kitchen, Living & Dining",
        "Kitchen Center Island · Custom Cabinetry",
        "Bonus Den with Built-In Gas Fireplace",
        "2nd-Floor Covered Porch · Hardwood",
        "Half Bath for Guests",
      ],
    },
    {
      id: "top",
      name: "Top Floor — Master Suites",
      image: floorAttic,
      description: "Private bedroom retreats with custom tile bathrooms — a quiet sanctuary above the great room, framed by ocean breezes and the elevated coastal light Ocean City is known for.",
      highlights: [
        "Master Suites with Custom Tile Baths",
        "Premium Hardwood Flooring",
        "Multi-Zoned Climate Control",
        "Elevated Coastal Light & Breezes",
      ],
    },
  ],
};
...
const exteriorImages = [
  { src: ext01, alt: "1113 Simpson Ave — Front Exterior View" },
  { src: ext02, alt: "1113 Simpson Ave — Side Exterior" },
  { src: ext03, alt: "1113 Simpson Ave — Aerial Perspective" },
  { src: ext04, alt: "1113 Simpson Ave — Front Porch & Landscaping" },
  { src: ext05, alt: "1113 Simpson Ave — 2nd Floor Covered Porch" },
  { src: ext06, alt: "1113 Simpson Ave — Driveway & Garage" },
];

const interiorImages = [
  { src: intLiving, alt: "1113 Simpson Ave — Great Room & Living" },
  { src: intKitchen, alt: "1113 Simpson Ave — Gourmet Kitchen" },
  { src: intMasterbed, alt: "1113 Simpson Ave — Master Suite" },
  { src: intBathroom, alt: "1113 Simpson Ave — Custom Tile Bathroom" },
  { src: intDining, alt: "1113 Simpson Ave — Dining & Bonus Den" },
  { src: intJrMaster, alt: "1113 Simpson Ave — Junior Master Bedroom" },
];
...
const SimpsonAve = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Thank you. Our team will be in touch regarding 1113 Simpson Ave shortly.");
    ...
    <main className="min-h-screen">
          ...
          <div className="max-w-3xl animate-fade-in-up">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-6 text-white/80">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs md:text-sm">3.5 Bathrooms</span>
              </div>
              <div className="flex items-center gap-2">
                <MapPin className="w-4 h-4 md:w-5 md:h-5" strokeWidth={1.5} />
                <span className="text-xs md:text-sm">Center of the Island · Ocean City</span>
              </div>
            </div>
        ...
        <div ref={visionRef} className="container mx-auto px-6 lg:px-12">
          <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center transition-all duration-1000 ${visionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="order-2 lg:order-1">
              ...
              <h2 className="heading-section text-charcoal mb-6">Upside-Down Coastal Living</h2>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8 p-6 bg-sand border border-border-subtle">
                ...
                <div className="text-center border-x border-border-subtle">
                  <p className="text-2xl font-serif text-charcoal">3.5</p>
              ...
              <div className="space-y-6">
                <p className="text-body">
                  <strong className="text-charcoal">Ground Level:</strong> Private bedrooms, full hall bath, elevator landing, and direct access from the 2-car garage. Enclosed outdoor shower for effortless beach-day returns.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">Second Floor — Great Room:</strong> The upside-down living level — gourmet kitchen with center island and custom cabinetry, open living and dining, half bath, and a bonus den anchored by a built-in gas fireplace, opening to a 2nd-floor covered hardwood porch.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">Top Floor — Master Suites:</strong> Private bedrooms and custom tile bathrooms — a quiet sanctuary above the great room, framed by elevated coastal light.
                </p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <div className="relative">
                <img
                  src={ext03}
                  alt="1113 Simpson Ave — Aerial View"
                ...
                <div className="absolute -bottom-6 -left-6 w-40 h-24 border border-border bg-white flex items-center justify-center p-4">
                  <div className="text-center">
                    <p className="text-xs uppercase tracking-wider text-muted-slate mb-1">Center of Island</p>
                    <p className="text-sm font-serif text-charcoal">40' × 115' Lot</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div ref={locationRef} className="container mx-auto px-6 lg:px-12 max-w-7xl">
          <div className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ${locationVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="relative h-[400px] lg:h-[500px] bg-muted">
              <iframe
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=1113+Simpson+Ave,+Ocean+City,+NJ"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div>
              ...
              <h2 className="heading-section text-charcoal mb-6">Life at the Shore</h2>
              <div className="divider mb-8" />
      ...
      <nav className="border-t border-border py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl flex items-center justify-between">
          <Link to="/developments/current-projects/2029-asbury-ave" className="text-xs tracking-[0.15em] uppercase text-muted-slate hover:text-charcoal transition-colors">
            ← 2029 Asbury Ave
          </Link>
