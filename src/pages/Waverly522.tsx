...
import subpageHero from "@/assets/waverly-522-ext-01.jpg";
import ext01 from "@/assets/waverly-522-ext-01.jpg";
import ext02 from "@/assets/waverly-522-ext-02.jpg";
import ext03 from "@/assets/waverly-522-ext-03.jpg";
import ext04 from "@/assets/waverly-522-ext-04.jpg";
import ext05 from "@/assets/waverly-522-ext-05.jpg";
import ext06 from "@/assets/waverly-522-ext-06.jpg";
import floorGround from "@/assets/waverly-522-floor-first-3d.jpg";
import floorFirst from "@/assets/waverly-522-floor-second-3d.jpg";
import floorSecond from "@/assets/waverly-522-floor-attic-3d.jpg";
import intLiving from "@/assets/waverly-522-int-living.jpg";
import intDining from "@/assets/waverly-522-int-dining.jpg";
import intBed01 from "@/assets/waverly-522-int-bed-01.jpg";
import intBed02 from "@/assets/waverly-522-int-bed-02.jpg";
import intBath01 from "@/assets/waverly-522-int-bath-01.jpg";
import intBath02 from "@/assets/waverly-522-int-bath-02.jpg";

const propertyData = {
  name: "522 Waverly Blvd",
  unit: "Gardens Single-Family Residence",
  headline: "A Halliday Architects Coastal Estate",
  tagline: "A new-construction single-family masterpiece in Ocean City's exclusive East-side Gardens neighborhood — five bedrooms, four-and-a-half baths, three stories, elevator, in-ground pool, detached garage, and a backyard oasis.",
  description: "Offered by Ocean City Development Group and designed by Halliday Architects, 522 Waverly Blvd is a three-story new-construction residence in Ocean City's coveted Gardens neighborhood. Natural cedar shake siding, brick accents, wide-plank hardwood floors, a five-star gourmet kitchen, custom-tiled bathrooms, a private elevator, and a spa-like in-ground pool with backyard oasis define a home built to the highest coastal standard.",
  ...
  specs: [
    { icon: "fireplace", title: "Gas Log Fireplace", description: "A gas log fireplace anchors the great room — a refined centerpiece for relaxed Gardens evenings." },
    { icon: "hardwood", title: "Wide-Plank Hardwood Floors", description: "Rich wide-plank hardwood flooring runs through every level, paired with custom tile in the wet rooms." },
    { icon: "hvac", title: "Multi-Zoned Gas Heat & Central AC", description: "Forced-air natural-gas heating with multi-zoned central air conditioning for year-round, room-by-room comfort." },
    { icon: "rooftop", title: "Five-Star Gourmet Kitchen", description: "A chef-grade gourmet kitchen with center island, premium appliance package, and walk-in pantry." },
  ],
  luxuryFeatures: [
    "OCDG single-family new construction",
    "3-story home · 48 × 100 Gardens lot",
    "Halliday Architects design",
    "Natural cedar shake siding · brick accents",
    "Wide-plank hardwood floors throughout",
    "Five-star gourmet kitchen · center island",
    "Custom-tiled spa-like bathrooms · walk-in closets",
    "Private residential elevator · all levels",
    "In-ground pool · fenced yard · backyard oasis",
    "Detached one-car garage · concrete driveway",
    "Multi-zoned forced-air gas heat & central AC",
    "Gas log fireplace · great room",
    "Great room · eat-in kitchen · formal dining",
    "Deck · patio · sprinkler system · sidewalks",
  ],
  locationFeatures: [
    "Ocean City's exclusive East-side Gardens neighborhood",
    "Quiet boulevard moments from Gardens Parkway and the bay",
    "Steps to the boardwalk, beach, and downtown Ocean City",
    "Lot 15 · Block 70.54 · 48 × 100",
  ],
  highlights: [
  ...
  floorPlans: [
    {
      ...
      name: "Ground Floor",
      image: floorGround,
      description: "The main living level — an open great room with gas log fireplace, formal dining room, eat-in kitchen with center island and pantry, and a powder room. Wide-plank hardwood floors and natural light define the social heart of the home.",
      highlights: [
    ...
    },
    {
      ...
      name: "First Floor",
      image: floorFirst,
      description: "The primary bedroom level — a master suite with custom-tiled spa-like bath and walk-in closet, two additional bedrooms with ensuite or hall bath access, and dedicated laundry.",
      highlights: [
        "Master Suite · Spa-Like Tile Bath",
        "Walk-In Closet",
        "Two Additional Bedrooms",
        "Custom-Tiled Hall Bath",
    ...
    },
    {
      ...
      name: "Second Floor",
      image: floorSecond,
      description: "The upper retreat — two additional bedrooms, a full bathroom, mechanical and storage space, and elevator access. A flexible level for guests, family, or a dedicated home office.",
      highlights: [
        "Bedroom #4 · Bedroom #5",
        "Full Bathroom",
        "Mechanical & Storage",
...
const exteriorImages = [
  { src: ext01, alt: "522 Waverly Blvd — Front Exterior at Dusk" },
  { src: ext02, alt: "522 Waverly Blvd — Backyard with Pool & Detached Garage" },
  { src: ext03, alt: "522 Waverly Blvd — Aerial Perspective" },
  { src: ext04, alt: "522 Waverly Blvd — Front Porch Detail" },
  { src: ext05, alt: "522 Waverly Blvd — Covered Porch & Cedar Shake" },
  { src: ext06, alt: "522 Waverly Blvd — Pool Patio at Twilight" },
];

const interiorImages: { src: string; alt: string }[] = [
  { src: intLiving, alt: "522 Waverly Blvd — Great Room with Coffered Ceiling & Fireplace" },
  { src: intDining, alt: "522 Waverly Blvd — Open-Plan Dining & Gourmet Kitchen" },
  { src: intBed01, alt: "522 Waverly Blvd — Primary Suite with Private Balcony" },
  { src: intBed02, alt: "522 Waverly Blvd — Guest Bedroom with Garden Views" },
  { src: intBath01, alt: "522 Waverly Blvd — Spa-Like Primary Bath with Soaking Tub" },
  { src: intBath02, alt: "522 Waverly Blvd — Custom-Tiled Guest Bath" },
];
...
const Waverly522 = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Thank you. Our team will be in touch regarding 522 Waverly Blvd shortly.");
    ...
    <main className="min-h-screen">
          ...
          <div className="max-w-3xl animate-fade-in-up">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-6 text-white/80">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs md:text-sm">Gardens · Ocean City</span>
              </div>
            </div>
        ...
        <div ref={visionRef} className="container mx-auto px-6 lg:px-12">
          <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center transition-all duration-1000 ${visionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="order-2 lg:order-1">
              ...
              <h2 className="heading-section text-charcoal mb-6">A Gardens Coastal Estate</h2>
              ...
              <div className="space-y-6">
                <p className="text-body">
                  <strong className="text-charcoal">Ground Floor:</strong> An open great room with gas log fireplace flows into the formal dining room and a five-star gourmet kitchen with center island, walk-in pantry, and direct deck access — completed by a powder room.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">First Floor:</strong> A master suite with custom-tiled spa-like bath and walk-in closet, two additional bedrooms, custom-tiled hall bath, and dedicated laundry.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">Second Floor:</strong> Two additional bedrooms, a full bathroom, and mechanical/storage — a flexible upper retreat for guests or family.
                </p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <div className="relative">
                <img
                  src={ext03}
                  alt="522 Waverly Blvd — Aerial Perspective"
                ...
                <div className="absolute -bottom-6 -left-6 w-40 h-24 border border-border bg-white flex items-center justify-center p-4">
                  <div className="text-center">
                    <p className="text-xs uppercase tracking-wider text-muted-slate mb-1">Gardens</p>
                    <p className="text-sm font-serif text-charcoal">Coastal Estate</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="specs" className="section-padding section-sand">
        <div ref={specsRef} className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl">
          ...
          <div className="text-center mt-12">
            <a
              href="https://sjsr.paragonrels.com/paragonls/publink/view.mvc/?GUID=50a619a7-bf06-4003-a356-6b52792093f3&Report=Yes"
              target="_blank"
        ...
        <div ref={locationRef} className="container mx-auto px-6 lg:px-12 max-w-7xl">
          <div className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ${locationVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="relative h-[400px] lg:h-[500px] bg-muted">
              <iframe
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=522+Waverly+Blvd,+Ocean+City,+NJ"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div>
              ...
              <h2 className="heading-section text-charcoal mb-6">Life on Waverly Boulevard</h2>
              <div className="divider mb-8" />
      ...
      <nav className="border-t border-border py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl flex items-center justify-between">
          <Link to="/developments/current-projects/38-arkansas-ave" className="text-xs tracking-[0.15em] uppercase text-muted-slate hover:text-charcoal transition-colors">
            ← 38 Arkansas Ave
          </Link>
