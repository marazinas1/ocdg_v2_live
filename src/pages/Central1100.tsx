...
import subpageHero from "@/assets/central-1100-ext-01.jpg";
import ext01 from "@/assets/central-1100-ext-01.jpg";
import ext02 from "@/assets/central-1100-ext-02.jpg";
import ext03 from "@/assets/central-1100-ext-03.jpg";
import ext04 from "@/assets/central-1100-ext-04.jpg";
import ext05 from "@/assets/central-1100-ext-05.jpg";
import ext06 from "@/assets/central-1100-ext-06.jpg";
import floorGround from "@/assets/central-1100-floor-ground.jpg";
import floorFirst from "@/assets/central-1100-floor-first.jpg";
import floorSecond from "@/assets/central-1100-floor-second.jpg";
import intLiving from "@/assets/central-1100-int-living.jpg";
import intKitchen from "@/assets/central-1100-int-kitchen.jpg";
import intDining from "@/assets/central-1100-int-dining.jpg";
import intMaster from "@/assets/central-1100-int-master.jpg";
import intBath from "@/assets/central-1100-int-bath.jpg";
import intGuest from "@/assets/central-1100-int-guest.jpg";

const propertyData = {
  name: "1100 Central Ave",
  unit: "Single-Family Corner Home",
  headline: "Corner-Lot Coastal Living",
  tagline: "A rare single-family new construction on a Central Avenue corner lot — two finished levels, a private rooftop deck, and a 3-stop elevator just three blocks from Ocean City's beach and boardwalk.",
  description: "A new-construction single-family home crafted by Ocean City Development Group on a prized corner lot at Central Avenue and 11th Street. Two beautifully finished levels of open coastal living deliver four bedrooms, two and a half baths, a mudroom, and a gourmet kitchen with a center island. A private rooftop deck crowns the home, while a 3-stop elevator, full garage, and generous under-home storage make every shore-day return effortless. Vinyl, cedar shake, and board-and-batten siding define the elevated coastal exterior.",
  status: "Under Contract",
  price: "$2,595,000",
  location: { city: "Ocean City", state: "NJ" },
  details: { bedrooms: 4, fullBaths: 2, halfBaths: 1, totalRooms: 4, sqft: 2204 },
  contact: {
  ...
  specs: [
    { icon: "fireplace", title: "Gas Log Fireplace", description: "A gas log fireplace anchors the open great room — a warm centerpiece for gatherings on cool shore evenings." },
    { icon: "hardwood", title: "Hardwood Floors Throughout", description: "Wide-plank hardwood floors run throughout both finished levels for a clean, continuous coastal aesthetic." },
    { icon: "hvac", title: "Solar-Assist Gas Heat & Central AC", description: "Solar-assisted natural gas heating with a basement tank and full central air conditioning for year-round shore comfort." },
    { icon: "rooftop", title: "3-Stop Elevator & Rooftop Deck", description: "An accredited residential elevator serves all three levels, capped by a private rooftop deck with elevated coastal views." },
  ],
  luxuryFeatures: [
    "OCDG single-family new construction · 2026",
    "Vinyl, cedar shake & board-and-batten siding",
    "3-stop residential elevator",
    "Hardwood floors throughout",
    "Gas log fireplace · open great room",
    "Gourmet kitchen · center island · upgraded appliances",
    "Mudroom · pantry · storage attic",
    "Full appliance package · gas range · dishwasher · washer/dryer",
    "~2,204 sq ft living + covered porches + decks + rooftop deck",
    "Full garage · concrete driveway · ample under-home storage",
  ],
  locationFeatures: [
    "Prime corner lot — Central Avenue at 11th Street",
    "3 blocks to the beach and boardwalk",
    "Steps from Ocean City's downtown shopping district",
    "51 × 65 lot · Block 1104 · Lot 15",
  ],
  highlights: [
    { value: "4", label: "Bedrooms" },
    { value: "2.5", label: "Bathrooms" },
    { value: "2,204", label: "Sq Ft Living" },
    { value: "Roof", label: "Private Deck" },
  ...
  floorPlans: [
    {
      ...
      name: "Ground Level",
      image: floorGround,
      description: "The arrival level — a full one-car garage with concrete driveway, a finished foyer with the elevator landing, and generous under-home storage for all the beach essentials. Crawl-space construction with flood vents engineered for the coastal flood zone.",
      highlights: [
        "One-Car Garage · Concrete Driveway",
        "Foyer & Stair · Elevator Landing (Stop 1 of 3)",
        "Ample Under-Home Storage",
        "Coastal Flood-Zone Engineering",
      ],
    },
    {
      id: "first",
      name: "First Floor",
      image: floorFirst,
      description: "The main living level — an open great room with a gas log fireplace flowing into the dining area and a gourmet kitchen with a center island and upgraded appliances. A mudroom, pantry, powder room, and covered front porch complete the level. Hardwood floors throughout.",
      highlights: [
        "Open Great Room · Gas Log Fireplace",
        "Gourmet Kitchen · Center Island · Pantry",
        "Dining Area · Eat-In Kitchen",
        "Mudroom · Powder Room",
        "Covered Front Porch",
        "Elevator Stop 2 of 3",
      ],
    },
    {
      id: "second",
      name: "Second Floor",
      image: floorSecond,
      description: "The bedroom level — a master suite with private bath, three additional bedrooms, a full hall bath, and a dedicated laundry/utility room. A private deck extends the space outdoors, with a stair leading up to the rooftop deck above.",
      highlights: [
        "Master Suite with Private Bath",
        "Three Additional Bedrooms",
        "Full Hall Bath · Laundry/Utility Room",
        "Private Second-Floor Deck",
        "Stair to Rooftop Deck",
        "Elevator Stop 3 of 3",
      ],
    },
  ],
};
...
const exteriorImages = [
  { src: ext01, alt: "1100 Central Ave — Front Exterior" },
  { src: ext02, alt: "1100 Central Ave — Corner View" },
  { src: ext03, alt: "1100 Central Ave — Aerial Perspective" },
  { src: ext04, alt: "1100 Central Ave — Rooftop Deck" },
  { src: ext05, alt: "1100 Central Ave — Covered Porch" },
  { src: ext06, alt: "1100 Central Ave — Driveway & Garage" },
];

const interiorImages = [
  { src: intLiving, alt: "1100 Central Ave — Great Room" },
  { src: intKitchen, alt: "1100 Central Ave — Gourmet Kitchen" },
  { src: intDining, alt: "1100 Central Ave — Dining Area" },
  { src: intMaster, alt: "1100 Central Ave — Master Suite" },
  { src: intBath, alt: "1100 Central Ave — Bath" },
  { src: intGuest, alt: "1100 Central Ave — Guest Bedroom" },
];
...
const Central1100 = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Thank you. Our team will be in touch regarding 1100 Central Ave shortly.");
    ...
    <main className="min-h-screen">
          ...
          <div className="max-w-3xl animate-fade-in-up">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-6 text-white/80">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs md:text-sm">Corner Lot · 3 Blocks to Beach</span>
              </div>
            </div>
        ...
        <div ref={visionRef} className="container mx-auto px-6 lg:px-12">
          <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center transition-all duration-1000 ${visionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="order-2 lg:order-1">
              ...
              <h2 className="heading-section text-charcoal mb-6">A Corner-Lot Statement on Central Avenue</h2>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8 p-6 bg-sand border border-border-subtle">
                ...
                <div className="text-center">
                  <p className="text-2xl font-serif text-charcoal">{propertyData.details.sqft.toLocaleString()}</p>
                  <p className="text-xs uppercase tracking-wider text-muted-slate">Sq Ft</p>
                </div>
              </div>
              <div className="space-y-6">
                <p className="text-body">
                  <strong className="text-charcoal">Ground Level:</strong> A full one-car garage, concrete driveway, finished foyer with the elevator landing, and generous under-home storage — built on crawl-space construction engineered for the coastal flood zone.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">First Floor:</strong> An open great room with a gas log fireplace flows into the dining area and a gourmet kitchen with center island and upgraded appliances. A mudroom, pantry, powder room, and covered front porch complete the main living level.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">Second Floor & Rooftop:</strong> A master suite with private bath plus three additional bedrooms, a full hall bath, and a dedicated laundry room. A private second-floor deck and a stair-accessed rooftop deck deliver elevated coastal moments above the corner.
                </p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <div className="relative">
                <img
                  src={ext03}
                  alt="1100 Central Ave — Aerial View"
                ...
                <div className="absolute -bottom-6 -left-6 w-40 h-24 border border-border bg-white flex items-center justify-center p-4">
                  <div className="text-center">
                    <p className="text-xs uppercase tracking-wider text-muted-slate mb-1">Corner Lot</p>
                    <p className="text-sm font-serif text-charcoal">3 Blocks to Sand</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div ref={locationRef} className="container mx-auto px-6 lg:px-12 max-w-7xl">
          <div className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ${locationVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="relative h-[400px] lg:h-[500px] bg-muted">
              <iframe
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=1100+Central+Ave,+Ocean+City,+NJ"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div>
              ...
              <h2 className="heading-section text-charcoal mb-6">Life on Central Avenue</h2>
              <div className="divider mb-8" />
      ...
      <nav className="border-t border-border py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl flex items-center justify-between">
          <Link to="/developments/current-projects/4138-asbury-ave" className="text-xs tracking-[0.15em] uppercase text-muted-slate hover:text-charcoal transition-colors">
            ← 4138 Asbury Ave
          </Link>
