...
import { Bed, Bath, Building2, Waves, ChefHat, Sparkles, Home, X, ChevronLeft, ChevronRight, Download, Phone, Mail, MapPin } from "lucide-react";
import asburyHero from "@/assets/asbury-ext-01.jpg";
import { toast } from "sonner";
import { useScrollReveal } from "@/hooks/useScrollReveal";

// Images
import extView1 from "@/assets/dundee-ext-view1.jpg";
import extView2 from "@/assets/dundee-ext-view2.jpg";
import extView3 from "@/assets/dundee-ext-view3.jpg";
import extView4 from "@/assets/dundee-ext-view4.jpg";
import extView5 from "@/assets/dundee-ext-view5.jpg";
import extView6 from "@/assets/dundee-ext-view6.jpg";
import intView1 from "@/assets/dundee-int-01.jpg";
import intView2 from "@/assets/dundee-int-02.jpg";
import intView3 from "@/assets/dundee-int-03.jpg";
import intView4 from "@/assets/dundee-int-04.jpg";
import intView5 from "@/assets/dundee-int-05.jpg";
import intView6 from "@/assets/dundee-int-06.jpg";
import floorGround from "@/assets/dundee-floor-ground.jpg";
import floor1st from "@/assets/dundee-floor-1st.jpg";
import floor2nd from "@/assets/dundee-floor-2nd.jpg";
...
const floorPlans = [
  {
    ...
    name: "Ground Floor",
    image: floorGround,
    description: "Two-car garage, private pool & patio oasis, outdoor entertaining space, and entry access to the home.",
    highlights: [
      "Two-car garage",
      "Private pool & spa",
      "Outdoor entertaining patio",
      "Professional landscaping",
      "Direct entry to home",
    ],
  },
  {
    id: "first",
    name: "First Floor",
    image: floor1st,
    description: "The main living level featuring an open-concept kitchen, living, and dining area, plus a Junior Master Suite with private bath.",
    highlights: [
      "Open-concept living & dining",
      "Designer gourmet kitchen",
      "Junior Master Suite with ensuite",
      "Half bath for guests",
      "Wrap-around deck access",
    ],
  },
  {
    id: "second",
    name: "Second Floor",
    image: floor2nd,
    description: "The bedroom level with the Primary Suite and additional bedrooms, each thoughtfully designed for comfort and privacy.",
    highlights: [
      "Primary Suite with ensuite bath",
      "Walk-in closets",
      "Additional bedrooms",
      "Full shared bathroom",
      "Laundry room",
    ],
    badge: "Primary Suite Level",
  },
];

// ─── Gallery Images ───
const exteriorImages = [
  { src: extView1, alt: "19 E Dundee Road — Front Exterior" },
  { src: extView2, alt: "19 E Dundee Road — Pool & Rear View" },
  { src: extView3, alt: "19 E Dundee Road — Aerial View" },
  { src: extView4, alt: "19 E Dundee Road — Side Detail" },
  { src: extView5, alt: "19 E Dundee Road — Pool & Patio" },
  { src: extView6, alt: "19 E Dundee Road — Evening View" },
];

const interiorImages = [
  { src: intView1, alt: "19 E Dundee Road — Living Room" },
  { src: intView2, alt: "19 E Dundee Road — Kitchen" },
  { src: intView3, alt: "19 E Dundee Road — Dining & Living" },
  { src: intView4, alt: "19 E Dundee Road — Bedroom" },
  { src: intView5, alt: "19 E Dundee Road — Bathroom" },
  { src: intView6, alt: "19 E Dundee Road — Primary Bath" },
];
...
// ─── Specs Data ───
const specs = [
  { icon: "pool", title: "Private Pool & Oasis", description: "Custom-designed outdoor living space with sparkling pool and professional landscaping." },
  { icon: "kitchen", title: "Designer Kitchen", description: "High-end cabinetry, stone countertops, and top-tier appliances for the discerning chef." },
  { icon: "finishes", title: "Junior Master Suite", description: "Convenient first-floor suite with private bath, perfect for guests or multi-generational living." },
  { icon: "location", title: "Premier Location", description: "Situated on a prime corner lot in The Gardens, just steps from the beach." },
];

const luxuryFeatures = [
  "Private pool & outdoor oasis",
  "Designer gourmet kitchen",
  "Junior Master Suite on first floor",
  "Primary Suite with walk-in closets",
  "Open-concept living spaces",
  "Multiple wrap-around decks",
  "Two-car garage",
  "Professional landscaping",
  "Premium hardwood flooring",
  "Corner lot in The Gardens",
];
...
const DundeePage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Thank you. Our team will send the 19 E Dundee Road digital brochure to your email shortly.");
          ...
          <div className="max-w-3xl animate-fade-in-up">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-6 text-white/80">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs md:text-sm">5 Bedrooms</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs md:text-sm">2 Stories</span>
              </div>
              <div className="flex items-center gap-2">
                <Waves className="w-4 h-4 md:w-5 md:h-5" strokeWidth={1.5} />
                <span className="text-xs md:text-sm">Private Pool</span>
              </div>
            </div>
            <p className="text-base md:text-lg lg:text-xl text-white/80 font-light leading-relaxed mb-8 md:mb-10 max-w-2xl">
              An exceptional new construction in the prestigious Gardens location — steps from the beach.
            </p>
            <button
        ...
        <div ref={visionRef} className="container mx-auto px-6 lg:px-12">
          <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center transition-all duration-1000 ${visionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="order-2 lg:order-1">
              ...
              <h2 className="heading-section text-charcoal mb-6">Gardens Luxury Redefined</h2>
              <div className="divider mb-8" />
              <div className="grid grid-cols-3 gap-4 mb-8 p-6 bg-sand border border-border-subtle">
                <div className="text-center">
                  <p className="text-2xl font-serif text-charcoal">5</p>
                ...
                <div className="text-center">
                  <p className="text-2xl font-serif text-charcoal">2</p>
                  <p className="text-xs uppercase tracking-wider text-muted-slate">Stories</p>
                </div>
              </div>
              <div className="space-y-6">
                <p className="text-body">
                  An exceptional new construction opportunity in the prestigious Gardens location. This Halliday Architects masterpiece features an open-concept layout, high-end finishes, and a private oasis with a sparkling pool and professional landscaping.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">Ground Floor:</strong> Two-car garage, private pool and patio oasis with professional landscaping, and entry access to the home.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">First Floor:</strong> Open-concept living, dining, and designer kitchen with a convenient Junior Master Suite featuring a private bath. Wrap-around deck access.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">Second Floor:</strong> The Primary Suite with walk-in closets and ensuite bath, plus additional bedrooms, full shared bath, and laundry room.
                </p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <div className="relative">
                <img src={extView2} alt="19 E Dundee Road — Pool view" className="w-full aspect-[4/5] object-cover" loading="lazy" decoding="async" />
                <div className="absolute -bottom-6 -left-6 w-40 h-24 border border-border bg-white flex items-center justify-center p-4">
                  <div className="text-center">
                    <p className="text-xs uppercase tracking-wider text-muted-slate mb-1">The Gardens</p>
                    <p className="text-sm font-serif text-charcoal">Corner Lot</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="specs" className="section-padding section-sand">
        <div ref={specsRef} className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl">
          <div className={`text-center max-w-2xl mx-auto mb-12 md:mb-16 transition-all duration-1000 ${specsVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <h2 className="heading-section text-charcoal">Crafted for Living</h2>
          </div>
        ...
        <div ref={locationRef} className="container mx-auto px-6 lg:px-12 max-w-7xl">
          <div className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ${locationVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="relative h-[400px] lg:h-[500px] bg-muted">
              <iframe
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=19+E+Dundee+Rd,+Ocean+City,+NJ"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div>
              ...
              <h2 className="heading-section text-charcoal mb-6">The Gardens, Ocean City</h2>
              <div className="divider mb-8" />
              <div className="flex items-start gap-4 mb-8">
                <MapPin className="w-5 h-5 text-charcoal mt-1 flex-shrink-0" />
                <div>
                  <p className="text-lg font-serif text-charcoal">19 E Dundee Road</p>
                  <p className="text-body">Ocean City, NJ</p>
                </div>
              </div>
              <ul className="space-y-4">
                {[
                  "Prime corner lot in Ocean City's exclusive Gardens neighborhood",
                  "Steps from the beach — premier ocean-side location",
                  "Private pool & outdoor oasis on a spacious lot",
        ...
        <div ref={registerRef} className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl">
          <div className={`max-w-xl mx-auto transition-all duration-1000 ${registerVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="text-center mb-12">
              ...
              <p className="text-body">
                Register your interest to receive priority access to architectural plans, pricing details, and exclusive updates for 19 E Dundee Road.
              </p>
            </div>
