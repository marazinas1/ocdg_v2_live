...
import subpageHero from "@/assets/asbury-4138-ext-01.jpg";
import ext01 from "@/assets/asbury-4138-ext-01.jpg";
import ext02 from "@/assets/asbury-4138-ext-02.jpg";
import ext03 from "@/assets/asbury-4138-ext-03.jpg";
import ext04 from "@/assets/asbury-4138-ext-04.jpg";
import ext05 from "@/assets/asbury-4138-ext-05.jpg";
import ext06 from "@/assets/asbury-4138-ext-06.jpg";
import floorGround from "@/assets/asbury-4138-floor-ground.jpg";
import floorSecond from "@/assets/asbury-4138-floor-second.jpg";
import floorRoof from "@/assets/asbury-4138-floor-roof.jpg";
import intLiving from "@/assets/asbury-4138-int-living.jpg";
import intKitchen from "@/assets/asbury-4138-int-kitchen.jpg";
import intMaster from "@/assets/asbury-4138-int-master.jpg";
import intBath from "@/assets/asbury-4138-int-bath.jpg";
import intDining from "@/assets/asbury-4138-int-dining.jpg";
import intGuest from "@/assets/asbury-4138-int-guest.jpg";

const propertyData = {
  name: "4138 Asbury Ave",
  unit: "Unit #2 · Top Floor",
  headline: "Southend Coastal Sophistication",
  tagline: "An upscale Southend new construction by Halliday-Leonard — a top-floor 3 bedroom, 2 bath residence with a private roof deck, just one short block to the beach.",
  description: "Crafted by Halliday-Leonard, the premier Ocean City contractor, this elegant top-floor unit pairs an open great room with cathedral ceilings, a built-in gas fireplace, and a gourmet kitchen with a center island. A private rooftop deck delivers elevated coastal views, while a one-car attached garage and dedicated parking pad anchor effortless shore-side living. Ready for early Summer 2026.",
  status: "Under Contract",
  price: "$1,495,000",
  location: { city: "Ocean City", state: "NJ" },
  details: { bedrooms: 3, fullBaths: 2, halfBaths: 0, totalRooms: 6, sqft: 1152 },
  contact: {
  ...
  specs: [
    { icon: "fireplace", title: "Built-In Gas Fireplace", description: "A built-in gas log fireplace anchors the great room — the warm centerpiece of the open-concept living level." },
    { icon: "hardwood", title: "Hardwood & Cathedral Ceilings", description: "Hardwood flooring throughout the living level with soaring cathedral ceilings that elevate every room." },
    { icon: "hvac", title: "Forced Air Gas Heat & Central AC", description: "Natural gas forced-air heating paired with central air conditioning for year-round shore comfort." },
    { icon: "rooftop", title: "Private Roof Deck", description: "A 200 sq ft private roof deck delivering elevated coastal views — your top-floor retreat above the Southend." },
  ],
  luxuryFeatures: [
    "Halliday-Leonard new construction · top-floor unit",
    "Cathedral ceilings · hardwood floors throughout",
    "Built-in gas log fireplace · living room",
    "Gourmet kitchen with center island · custom cabinetry",
    "Master bath · custom tile finishes",
    "Full appliance package · gas range · dishwasher · washer/dryer",
    "1,152 sqft living + 198 sqft covered porches + 200 sqft roof deck",
    "2-car attached garage · auto opener · parking pad",
  ],
  locationFeatures: [
    "Just one short block to the beach",
    "Easy walk to Uncle Bill's & Southend dining",
    "30' × 100' lot · Block 4103 · Lot 23-C2",
    "Upscale Southend Ocean City corridor",
  ],
  highlights: [
    { value: "3", label: "Bedrooms" },
    { value: "2", label: "Bathrooms" },
    { value: "1,152", label: "Sq Ft Living" },
  ...
  floorPlans: [
    {
      ...
      name: "Ground Level",
      image: floorGround,
      description: "The arrival level — a 2-car attached garage with auto door opener, dedicated parking pad, outdoor showers, and private entry stairs leading up to the residences. Designed for effortless beach-day returns and quiet street-side presence.",
      highlights: [
        "2-Car Attached Garage · Auto Opener",
        "Private Parking Pad",
        "Outdoor Showers",
        "Dedicated Interior Entry Stairs",
      ],
    },
    {
      id: "first",
      name: "First Floor",
      image: floorSecond,
      description: "The first residential level — open-concept great room with a built-in gas fireplace, gourmet kitchen with center island, and a dining area opening to a covered front porch. Three bedrooms — including a master suite with private bath — and a full hall bath complete the level. Hardwood floors throughout.",
      highlights: [
        "Open Great Room · Built-In Gas Fireplace",
    ...
    },
    {
      ...
      name: "Second Floor",
      image: floorRoof,
      description: "The top-floor residence — Unit #2. Cathedral ceilings crown an open great room with a built-in gas fireplace, gourmet kitchen with center island, and a dining area extending to a private 200 sq ft roof deck for elevated coastal views. Three bedrooms — including the master suite with private bath — and a full hall bath complete the home.",
      highlights: [
        "Cathedral Ceilings · Open Great Room",
        "Gourmet Kitchen · Center Island",
        "Master Bedroom with Master Bath",
        "Two Additional Bedrooms · Full Hall Bath",
        "Private 200 sq ft Roof Deck",
        "Built-In Gas Fireplace · Hardwood Floors",
      ],
    },
  ],
};
...
const exteriorImages = [
  { src: ext01, alt: "4138 Asbury Ave — Front Exterior" },
  { src: ext02, alt: "4138 Asbury Ave — Rear View" },
  { src: ext03, alt: "4138 Asbury Ave — Aerial Perspective" },
  { src: ext04, alt: "4138 Asbury Ave — Roof Deck" },
  { src: ext05, alt: "4138 Asbury Ave — Covered Porch" },
  { src: ext06, alt: "4138 Asbury Ave — Driveway & Garage" },
];

const interiorImages = [
  { src: intLiving, alt: "4138 Asbury Ave — Great Room" },
  { src: intKitchen, alt: "4138 Asbury Ave — Gourmet Kitchen" },
  { src: intMaster, alt: "4138 Asbury Ave — Master Suite" },
  { src: intBath, alt: "4138 Asbury Ave — Custom Tile Bath" },
  { src: intDining, alt: "4138 Asbury Ave — Dining Area" },
  { src: intGuest, alt: "4138 Asbury Ave — Guest Bedroom" },
];
...
const Asbury4138 = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success("Thank you. Our team will be in touch regarding 4138 Asbury Ave shortly.");
    ...
    <main className="min-h-screen">
          ...
          <div className="max-w-3xl animate-fade-in-up">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-6 text-white/80">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs md:text-sm">Southend · One Block to Beach</span>
              </div>
            </div>
        ...
        <div ref={visionRef} className="container mx-auto px-6 lg:px-12">
          <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center transition-all duration-1000 ${visionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="order-2 lg:order-1">
              ...
              <h2 className="heading-section text-charcoal mb-6">Top-Floor Southend Living</h2>
              ...
              <div className="space-y-6">
                <p className="text-body">
                  <strong className="text-charcoal">Ground Level:</strong> A 2-car attached garage with auto door opener, dedicated parking pad, and outdoor showers — quiet, refined arrival just one short block from the sand.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">First Floor:</strong> Open-concept great room with a built-in gas fireplace, gourmet kitchen with center island, and a dining area opening to a covered front porch. Three bedrooms — including a master suite — and a full hall bath complete this residential level.
                </p>
                <p className="text-body">
                  <strong className="text-charcoal">Second Floor — The Top-Floor Residence:</strong> Unit #2. Cathedral ceilings crown an open great room with built-in gas fireplace and gourmet kitchen, flowing to a private 200 sq ft roof deck with elevated coastal views — your top-floor retreat above the Southend.
                </p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <div className="relative">
                <img
                  src={ext03}
                  alt="4138 Asbury Ave — Aerial View"
                ...
                <div className="absolute -bottom-6 -left-6 w-40 h-24 border border-border bg-white flex items-center justify-center p-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm font-serif text-charcoal">One Block to Sand</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div ref={floorRef} className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl">
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-8 items-start transition-all duration-1000 delay-300 ${floorVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            ...
            <div className="bg-background-sand p-6 md:p-8 order-2 lg:order-1" style={{ borderRadius: "4px" }}>
              <h3 className={`heading-card mb-4 ${currentFloor?.id === "second" ? "text-primary" : "text-charcoal"}`}>
                {currentFloor?.name}
              </h3>
        ...
        <div ref={locationRef} className="container mx-auto px-6 lg:px-12 max-w-7xl">
          <div className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ${locationVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="relative h-[400px] lg:h-[500px] bg-muted">
              <iframe
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=4138+Asbury+Ave,+Ocean+City,+NJ"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div>
              ...
              <h2 className="heading-section text-charcoal mb-6">Life at the Southend</h2>
              <div className="divider mb-8" />
      ...
      <nav className="border-t border-border py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl flex items-center justify-between">
          <Link to="/developments/current-projects/1113-simpson-ave" className="text-xs tracking-[0.15em] uppercase text-muted-slate hover:text-charcoal transition-colors">
            ← 1113 Simpson Ave
          </Link>
          ...
          <Link to="/developments/current-projects/1100-central-ave" className="text-xs tracking-[0.15em] uppercase text-muted-slate hover:text-charcoal transition-colors">
            1100 Central Ave →
          </Link>
        </div>
      </nav>
